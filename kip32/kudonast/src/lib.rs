...
pub type UdonResolvedInternalSym = (UdonSpaciality, u32);
...
impl UdonInt {
    ...
    pub fn resolve(&self, symtab: &BTreeMap<String, UdonResolvedInternalSym>) -> Result<u32, String> {
        match self {
            Self::I(v) => Ok(*v),
            Self::Op(op) => Ok(op.opcode),
...
pub struct UdonOdinASTInsert {
    ...
    pub file: kudonodin::OdinASTFile,
...
pub struct UdonProgram {
    ...
    /// Using a U64 here is a hack for now.
