...
kip32: kip32-libc
	...
	sdk/kip32-libcqemu-gcc -g -O3 testing/muldiv.S testing/tiolib.c testing/qemu_stdio.c testing/genrefdata.c -o testing/genrefdata.elf
	KIP32CC_OVERRIDE_ARCH=rv32i sdk/kip32-udon-gcc -O3 testing/science.c -S -o testing/science.s
	KIP32CC_OVERRIDE_ARCH=rv32i sdk/kip32-udon-gcc -O3 testing/science.c testing/tiolib.c testing/muldiv.S -o testing/science.elf -Wl,-Map=testing/science.map
...
kip32-libc:
	...
	../kip32-libcqemu-gcc -g -O3 ../../testing/libctest.c ../../testing/tiolib.c ../../testing/qemu_stdio.c -o ../../testing/libctest.elf
