...
* The new networking metadata -- is there any in `IUdonProgram`?
* Network metadata type numbers
* Add OdinSerializer overview -- work out which version they're using, document
...
The Udon program's bytes (after base64, or gzip, or etc.) are encoded using OdinSerializer.
